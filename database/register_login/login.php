<?php
    ...
    if ($count == 1) {
        ...
        echo "1"; //successful
        //sendSms($user['phone_number'], 'Login attempt was noticed today at ' . date('Y-m-d H:i:s') . ". If this wasn't you contact customer care NOW on 0268977129/0546545050 to rectify the issue. Thanks");
        } else {
